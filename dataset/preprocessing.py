...
Transform data into data ready to be inserted into the model.
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', type=str, help='Dataset file', default='dataset/raw_data.xlsx')
    parser.add_argument('-o', type=str, help='Output folder', default='dataset/processed_data/')
